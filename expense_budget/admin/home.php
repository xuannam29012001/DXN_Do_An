...
<h1>Chào mừng <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ngân sách chung hiện tại</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Mục nhập ngân sách ngày nay</span>
                <span class="info-box-number text-right">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Chi tiêu ngân sách ngày nay</span>
                <span class="info-box-number text-right">
                <?php 
...
<div class="row">
  <div class="col-lg-12">
    <h4>Ngân sách hiện tại trong mỗi danh mục</h4>
    <hr>
  </div>
</div>
...
<div class="col-md-12">
  <h3 class="text-center" id="noData" style="display:none">Không có dữ liệu hiển thị.</h3>
</div>
<script>
  function check_cats(){
